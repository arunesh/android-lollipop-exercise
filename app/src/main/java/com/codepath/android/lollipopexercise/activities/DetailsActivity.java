...
public class DetailsActivity extends AppCompatActivity implements Target {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.with(DetailsActivity.this).load(mContact.getThumbnailDrawable()).into(this);
